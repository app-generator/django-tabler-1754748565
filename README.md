...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-tabler-1754748565) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-tabler-1754748565.git
$ cd django-tabler-1754748565
```
